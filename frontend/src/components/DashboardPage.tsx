...
function DashboardPage() {
  ...
  // Map API status values to frontend status format
  ...
  const currentWorkflow = useMemo(() => {
    ...
    if (apiActiveWorkflows.length > 0) {
      ...
      return {
        ...
        startTime: rtWorkflow.details?.started_at || new Date().toISOString(),
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1.5rem", gridColumn: "1 / -1" }}>
          ...
          <section className="agents-panel dashboard-card" style={{ height: "600px", overflow: "hidden" }}>
            ...
            <div className="dashboard-card-footer">
              ...
              <button 
                onClick={handleRefreshData} 
                className={`action-button button-feedback ${activeButtons.refresh ? 'active' : ''}`}
              >
                Refresh
              </button>
            </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", height: "600px", gap: "1.5rem" }}>
            ...
            <div className="dashboard-card" style={{ flex: "1", overflow: "hidden" }}>
                  ...
                  <div className="workflow-details mt-3 p-3 bg-light rounded">
                    ...
                    <div className="workflow-details-grid">
                      ...
                      <div className="detail-row">
                        ...
                        <span className="detail-value">{new Date(currentWorkflow.startTime || Date.now()).toLocaleString()}</span>
                      </div>
                      <div className="detail-row">
              ...
              <div className="dashboard-card-footer">
                <div>
                  <span>Started: {new Date(currentWorkflow.startTime || Date.now()).toLocaleString()}</span>
                ...
                <div className="card-actions-footer">
                  <button 
                    className={`action-button button-feedback ${showWorkflowDetails ? 'active' : ''} ${activeButtons.viewDetails ? 'active' : ''}`} 
                    onClick={handleToggleWorkflowDetails}
            ...
            <div className="dashboard-card" style={{ flex: "1", overflow: "hidden" }}>
              <div className="dashboard-card-header">
                ...
                <div className="card-actions">
                  <span 
                    ...
                    style={{ cursor: 'pointer', fontSize: '0.9rem', opacity: expandedSteps ? '1' : '0.7' }} 
                    ...
                    >
                      ...
                      {step.status === 'completed' && step.output && (
                        <div style={{ marginTop: '0.5rem', position: 'relative' }}>
                          <div style={{ 
                            height: expandedSteps ? 'auto' : '1.5rem', 
                            ...
                            {expandedSteps ? step.output : step.output?.split('\n')[0]}
                            {!expandedSteps && (
                              <span style={{ 
                                position: 'absolute',
                                right: '0',
              ...
              <div className="dashboard-card-footer">
                ...
                <div className="card-actions-footer">
                  <button 
                    className={`action-button button-feedback ${expandedSteps ? 'active' : ''} ${activeButtons.expandAll ? 'active' : ''}`} 
                    onClick={handleToggleExpandSteps}
                  ...
                  <button 
                    className={`action-button button-feedback ${activeButtons.exportData ? 'active' : ''}`}
