...
const StatisticsPage: React.FC = () => {
  ...
  // Generate comparison data (this can be static or semi-dynamic)
  const generateComparisonData = (period: TimePeriod): ComparisonData[] => {
    return [
      {
        title: 'Crop Yield',
        current: 1847 / (period === 'yearly' ? 1 : period === 'monthly' ? 12 : 52),
        previous: 1645 / (period === 'yearly' ? 1 : period === 'monthly' ? 12 : 52),
        unit: 'tons',
        change: 12.3
      },
      {
        title: 'Revenue',
        current: 2100000 / (period === 'yearly' ? 1 : period === 'monthly' ? 12 : 52),
        previous: 1820000 / (period === 'yearly' ? 1 : period === 'monthly' ? 12 : 52),
        unit: '$',
        change: 15.4
      },
      {
        title: 'Water Usage',
        current: 45200000 / (period === 'yearly' ? 1 : period === 'monthly' ? 12 : 52),
        previous: 49300000 / (period === 'yearly' ? 1 : period === 'monthly' ? 12 : 52),
        unit: 'L',
        change: -8.3
      },
      {
