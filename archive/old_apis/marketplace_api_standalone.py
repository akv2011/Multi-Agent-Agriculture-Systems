...
sample_products = [
    ProductListing(
        ...
        images=["/uploads/product_images/basmati-rice.jpg", "/uploads/product_images/rice-field.jpg"],
        is_organic=False,
    ...
    ProductListing(
        ...
        images=["/uploads/product_images/wheat-flour.jpg", "/uploads/product_images/wheat-field.jpg"],
        is_organic=True,
    ...
    ProductListing(
        ...
        images=["/uploads/product_images/tomatoes.jpg", "/uploads/product_images/tomato-farm.jpg"],
        is_organic=False,
    ...
    ProductListing(
        ...
        images=["/uploads/product_images/cotton-bulk.jpg", "/uploads/product_images/cotton-field.jpg"],
        is_organic=False,
